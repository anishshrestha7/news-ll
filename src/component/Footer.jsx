    ...
    <>
      ...
      <footer className='con text-white border-t-4  border-[#f24d34] relative '>
        <div className=' bg-black/50'>
          <img className='w-full block h-70' src={logo} alt="" />
        </div>
        <div className='absolute top-0 left-3 font-normal flex justify-between w-[1200px]'>
        <div>
      ...
      <section className='con justify-center flex text-white bg-black py-3 text-sm font-medium'>
